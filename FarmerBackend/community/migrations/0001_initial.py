    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=community.models.post_upload_path, validators=[community.models.validate_file_size_20mb])),
                ('video', models.FileField(blank=True, null=True, upload_to=community.models.post_upload_path, validators=[community.models.validate_file_size_20mb])),
                ('voice', models.FileField(blank=True, null=True, upload_to=community.models.post_upload_path, validators=[community.models.validate_file_size_20mb])),
